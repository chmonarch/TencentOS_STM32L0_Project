...
#define TOS_CFG_MMHEAP_DEFAULT_POOL_SIZE        0x400	// 配置TencentOS tiny默认动态内存池大小
...
#define TOS_CFG_PWR_MGR_EN              1u		// 配置TencentOS tiny是否开启外设电源管理模块

#define TOS_CFG_TICKLESS_EN             1u		// 配置Tickless 低功耗模块开关
...
#define TOS_CFG_CPU_TICK_PER_SECOND     1u	// 配置TencentOS tiny的tick频率

#define TOS_CFG_CPU_CLOCK               (SystemCoreClock)	// 配置TencentOS tiny CPU频率

#define TOS_CFG_TIMER_AS_PROC           1u		// 配置是否将TIMER配置成函数模式

#define TOS_CFG_COMPLETION_EN 					1u		// 配置TencentOS tiny是否开启完成量组件开关

#define TOS_CFG_COUNTDOWNLATCH_EN 			1u		// 配置TencentOS tiny是否开启队列组件开关

//#define TOS_CFG_MMHEAP_POOL_SIZE 				0x2000	// 配置TencentOS tiny动态内存池大小
